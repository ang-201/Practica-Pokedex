...
public class Pokemon {
    ...
    public Pokemon(int id, String name, String description, int height, int weight, int base_experience,
                   List<TypeSlot> types, List<AbilitySlot> abilities, Sprite sprites,
                   List<StatSlot> stats, List<Evolution> evolutions) {
        this.id = id;
        this.name = name;
